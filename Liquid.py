...
class Liquid:
    ...
    def writeBottle(self):
        pygame.draw.line(self.display, (0, 0, 0), (32, (self.eachHeight[1]-self.height*self.centimeter*10)-16), (32, self.eachHeight[1]-1), 3)
        pygame.draw.line(self.display, (0, 0, 0), ((self.radius*self.centimeter*20) + 32, (self.eachHeight[1]-self.height*self.centimeter*10)-16), ((self.radius*self.centimeter*20) + 32, self.eachHeight[1]-1), 3)
